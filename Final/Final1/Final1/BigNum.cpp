...
BigNumber::BigNumber(string number) :_numberString(number)
{
...
BigNumber BigNumber::addll(const long long &other) {
	return this->add(BigNumber(other)); //point
}

BigNumber BigNumber::addstr(const string &other) {
	return this->add(BigNumber(other)); //point 
}
...
BigNumber BigNumber::subtract(BigNumber other) {
	...
	if (b1 < b2) {
		//Negative answer
		string t = b2.subtract(*this).negate().getString();
	...
	//fixes for numbers greater than 1... adds 0 to the left end of the number
...
BigNumber BigNumber::subtractstr(const string &other) {
	return this->subtract(BigNumber(other));
}
...
BigNumber BigNumber::multiplystr(const string &other) {
...
BigNumber BigNumber::dividestr(const string &other) {
	return this->divide(BigNumber(other));
}
...
BigNumber operator+(BigNumber b1, const string &b2) {
	return b1.addstr(b2);
}
...
bool operator==(BigNumber b1, const string &b2) {
	return b1.equals(b2);
}
...
unsigned int BigNumber::operator[](int index) {
	if (this->_numberString[index] == '-') {
		cerr << "Can't get negative sign from number" << endl;
	}
...
BigNumber& BigNumber::operator=(const long long &other) {
	this->_numberString = to_string(other);
	return *this;
}

BigNumber& BigNumber::operator=(const string &other) {
